...
function addMarker(place, area) {
  ...
  var url = 'https://bizno.net/api/fapi?key=dmVkZWxsYW4xNTE5QGdtYWlsLmNvbSAg&gb=3&q=' + place.place_name + '&type=json';
  if(area !== "지역") {
      url += '&area=' + area;
  }
  ...
  .then(resJson => {
    ...
    var xhr2 = new XMLHttpRequest();
		...
		opa1 = '&' + encodeURIComponent('opaBoheomFg') + '=' + encodeURIComponent('1'); /**/
    opa2 = '&' + encodeURIComponent('opaBoheomFg') + '=' + encodeURIComponent('2'); /**/
...
function showOffcanvas(gyData, sjData) {
  return function () {
    ...
    var offcanvasElement = document.getElementById('offcanvas');
		...
		contents[2].innerHTML = gySeongripDate.substr(0, 4) + '년 ' + gySeongripDate.substr(4, 2) + '월 ' + gySeongripDate.substr(6, 2) + '일';;
